...
class ProductPage(BasePage):
    ...
    def product_title_should_match_product_in_basket(self):
        ...
        assert product_title_text == success_alert_text, "Test product doesn't match product added to basket"
    ...
    def should_not_be_success_message(self):
        assert self.is_not_element_present(*ProductPageLocators.SUCCESS_MESSAGE_TEXT), \
            "Success message is presented, but should not be"

    def success_message_should_disappear(self):
        assert self.is_disappeared(*ProductPageLocators.SUCCESS_MESSAGE_TEXT), \
            "Success message is not disappeared, but should do"
